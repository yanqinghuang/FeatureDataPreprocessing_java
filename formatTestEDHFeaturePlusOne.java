 ...
 */
public class formatTestEDHFeaturePlusOne {
    public static void main(String[] args) {

        modifyFileStyle("D:\\mpeg7fex_win32_v2\\myEHDKnivesPlusOneFeature_112.txt",
                "D:\\mpeg7fex_win32_v2\\myEHDKnivesFeature_112.txt");
    }
    ...
    public static void modifyFileStyle(String testDst, String src) {
        ...
        String line;
        int lineNum = 0; //record the line count
        try {
